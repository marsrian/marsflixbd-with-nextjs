...
import TextArea from "@/components/form/TestArea";
...
const CreateBlog = () => {
  const CLOUD_NAME = "dmllzubi0";
  const UPLOAD_PRESET = "marsflixbd_images";
    ...
    <section className="container max-w-3xl mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 mb-4 md:mb-8">
        ...
        <div>
          ...
          >
            <option value="BanglaMovie">Bangla Movie</option>
            <option value="BollywoodMovie">Bollywood Movie</option>
            <option value="HollywoodMovie">Hollywood Movie</option>
            <option value="BanglaWebSeries">Bangla Web Series</option>
            <option value="HindiWebSeries">Hind Web Series</option>
